  ...
  function addToMap(csvText) {
    csv2geojson.csv2geojson(csvText, {
      ...
      (err, data) => {
        ...
        //location labels for clustered
        map.addLayer({
          id: 'location-labels-clustered',
          type: 'symbol',
          source: 'vacancies',
          filter: ['has', 'point_count'],
          layout: {
        ...
        map.on('mouseenter', 'clusters', displayPopup);
        map.on('mouseenter', 'unclustered', displayPopup);
